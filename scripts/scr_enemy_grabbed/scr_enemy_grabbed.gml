function scr_enemy_grabbed()
{
	...
	if (obj_player1.state == states.grabbing || obj_player1.state == states.grab || obj_player1.state == states.thrown || obj_player1.state == states.slam || obj_player1.state == states.tacklecharge)
	{
	    x = obj_player1.x;
	...
	with (obj_player1)
	{
	    ...
	    if (!(state == states.grab || state == states.finishingblow || state == states.grabbing || state == states.thrown || state == states.slam || state == states.tacklecharge || state == states.punch || state == states.superslam || state == states.backkick || state == states.uppunch || state == states.shoulder))
	    {
	        other.x = x;
	        other.y = y;
	...
	if (obj_player1.state == states.thrown)
	{
	    global.hit += 1;
